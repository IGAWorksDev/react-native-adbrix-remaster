...
//    }
    ...
    @ReactMethod
    public void setBigTextClientPushEvent(String bigTextPushPropertiesJson, boolean alwaysIsShown) {
        if(AdbrixUtils.isNullString(bigTextPushPropertiesJson)){
        ...
        AdBrixRm.setBigTextClientPushEvent(reactApplicationContext, AdBrixRm.BigTextPushProperties.fromJSONObject(jsonObject), alwaysIsShown);
    }

    @ReactMethod
    public void setBigPictureClientPushEvent(String bigPicturePushPropertiesJson, boolean alwaysIsShown) {
        if(AdbrixUtils.isNullString(bigPicturePushPropertiesJson)){
    ...
    @ReactMethod
    public void cancelClientPushEvent(int eventId) {
        AdBrixRm.cancelClientPushEvent(reactApplicationContext, eventId);
    }
    ...
    public void cancelLocalPushNotificationAll() {
        AdBrixRm.cancelLocalPushNotificationAll(reactApplicationContext);
    }
    @ReactMethod(isBlockingSynchronousMethod = true)
    public String getPushEventList() {
   ...
   public AdBrixRm.AbxRemotePushModel parsePushData(Bundle bundle) {
       return AdBrixRm.parsePushData(bundle);
   }
